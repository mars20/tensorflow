...
TfLiteRegistration* Register_AVERAGE_POOL_OPT() {
  static TfLiteRegistration r = {
      pooling::Init, pooling::Free, pooling::GenericPrepare<pooling::kAverage>,
      pooling::AverageEval<pooling::kOptimized>};
  return &r;
}

TfLiteRegistration* Register_MAX_POOL_OPT() {
  static TfLiteRegistration r = {pooling::Init, pooling::Free,
                                 pooling::GenericPrepare<pooling::kMax>,
                                 pooling::MaxEval<pooling::kOptimized>};
  return &r;
}

TfLiteRegistration* Register_L2_POOL_OPT() {
  static TfLiteRegistration r = {pooling::Init, pooling::Free,
                                 pooling::GenericPrepare<pooling::kL2>,
                                 pooling::L2Eval<pooling::kOptimized>};
  return &r;
}
